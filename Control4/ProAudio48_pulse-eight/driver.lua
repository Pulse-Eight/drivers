...
function pxSZ( paramT)
  ...
  if (zone > 48) then
    ...
    sendZoneSource( "DSZ", zone - 48, input, audioF, videoF)
    sendZoneSource( "DMZ", zone - 48, 0, audioF, videoF)
...
function pxDO( paramT)
  ...
  -- xxx
  if (zone > 48) then
    sendZoneSource( "DMZ", zone - 48, 1, audioF, videoF)
  else
...
--  if ((aAudioF + dAudioF) ~= 0) then
    ...
    loczone = zone + 3999 + 48      -- audio output bindings
