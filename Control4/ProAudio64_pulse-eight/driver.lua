...
function pxSZ( paramT)
  ...
  if (zone > 64) then
    ...
    sendZoneSource( "DSZ", zone - 64, input, audioF, videoF)
    sendZoneSource( "DMZ", zone - 64, 0, audioF, videoF)
...
function pxDO( paramT)
  ...
  -- xxx
  if (zone > 64) then
    sendZoneSource( "DMZ", zone - 64, 1, audioF, videoF)
  else
...
--  if ((aAudioF + dAudioF) ~= 0) then
    ...
    loczone = zone + 3999 + 64      -- audio output bindings
